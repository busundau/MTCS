...
// 	uspi->PROTCTL |= (0x00000004 << USPI_PROTCTL_TSMSEL_Pos);		//TSMSEL = 100b: Half-duplex SPI. 2022/09/28
// 	uspi->PROTCTL |= 0x00004000;									//TSMSEL = 100b: Half-duplex SPI. 2022/10/04 不需使用半雙工模式，因API也沒用到+模組沒支援
